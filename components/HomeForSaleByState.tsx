...
import { home_For_sale_by_state as agents } from '@/constants'
import { IoIosArrowDown, IoIosArrowUp } from "react-icons/io";

const HomeForSaleByState = () => {
   ...
   return (
      <section className="mx-auto px-4 py-8">
         <a href='https://www.homelight.com/homes' className='text-[#273653] font-bold text-base mb-5 inline-block'>Search homes for sale by state</a>
...
export default HomeForSaleByState
