...
import { top_Real_Estate_Agent_In_Major_US_Cities as agents } from '@/constants'
import { IoIosArrowDown, IoIosArrowUp } from "react-icons/io";

const RealEstateAgentsInMajorCities = () => {
   ...
   return (
      <section className="mx-auto px-4 py-8">
         <a href='https://www.homelight.com/find-real-estate-agents' className='text-[#273653] font-bold text-base mb-5 no-underline inline-block'>Find top real estate agents in major US cities</a>
...
export default RealEstateAgentsInMajorCities
